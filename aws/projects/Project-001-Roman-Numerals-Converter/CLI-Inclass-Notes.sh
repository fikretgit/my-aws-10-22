...
export AWS_PROFILE=user1 # export şirkette farklı user lar farklı projelerde çalışabilir. 
# export ile user ismini bir kez tanımlayıp her dosya ve ortamda aynı isime sahip olarak 
#çalışabilirsin.. ta ki farklı bir değer atanana ya da sistem kapatılana kadar..
export AWS_PROFILE=default

aws configure list-profiles

aws sts get-caller-identity
# user bilgilerini döküyor..
