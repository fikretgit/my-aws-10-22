...
- Tab Actions Menu ----> Networking ----> Enable Source/Destination Check ---> Yes, Disable (Enable Stop Button)
...
Private - Route Table da Route kısmında BlackHole u siliyoruz..
Security Groups may be deleted..
