...
- Launch an instance with following configurations.
  ...
  ```text
# bu benim web sayfası .. orijinali aşağıda.. !!
  #!/bin/bash
  ...
  rm index.html
  wget https://raw.githubusercontent.com/fikretgit/benim/main/mywebpage/index.html
  wget https://raw.githubusercontent.com/awsdevopsteam/route-53/master/banner.jpg
