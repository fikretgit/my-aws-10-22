...
- Click the S3 bucket `felix-pet.clarusway.lifecycle` and upload following files.
...
- Create a bucket of `source.replica.felix` with following properties, 
# isimler unique olmalı..!! o nedenle..!!
